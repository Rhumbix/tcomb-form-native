...
const Nil = t.Nil;
const util = require('@rhumbix/tcomb-json-schema').util;
...
class Component extends React.Component {
  ...
  getLocals() {
    return {
      ...
      viewable: this.props.options.viewable,
      editable: this.props.options.editable
    };
  }
...
class Textbox extends Component {
  ...
  getTransformer() {
    ...
    return options.transformer ? options.transformer :
      (this.typeInfo.innerType === util.Num || this.typeInfo.innerType === util.Int) ? Textbox.numberTransformer :
      Textbox.transformer;
  }
  ...
  getKeyboardType() {
    ...
    if (t.Nil.is(keyboardType) && (this.typeInfo.innerType === util.Num || this.typeInfo.innerType === util.Int)) {
      return 'numeric';
    }
    return keyboardType;
  }
...
export class List extends Component {
  ...
  getLocals() {
    ...
    locals.genNew = this.genNew.bind(this);
